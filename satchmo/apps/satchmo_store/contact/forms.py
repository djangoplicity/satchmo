...
class ContactInfoForm(ProxyContactForm):
    ...
    street1 = forms.CharField(max_length=80, label=_('Street'), required=False)
    street2 = forms.CharField(max_length=80, required=False)
    ...
    tax_code = forms.CharField(max_length=20, label=_('Tax code'), required=False,
        help_text=_('Tax Code for Argentina, Brazil, Peru, Paraguay (CUIT/CPF/RUC)'))
    ...
    ship_street2 = forms.CharField(max_length=80, required=False)
...
class AddressBookForm(forms.Form):
    ...
    street1 = forms.CharField(max_length=80, label=_('Street'), required=True)
    street2 = forms.CharField(max_length=80, required=False)
