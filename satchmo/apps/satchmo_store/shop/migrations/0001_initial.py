    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_model', models.CharField(blank=True, max_length=30, null=True, verbose_name='Shipping Models', choices=[(b'shipping.modules.tieredweight', 'Tiered Weight Shipping')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('payment', models.CharField(blank=True, max_length=25, verbose_name='Payment Method', choices=[('COPOSWEB', 'Credit Cards')])),
