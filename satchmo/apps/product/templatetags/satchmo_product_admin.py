...
def list_variations(configurableproduct):
    ...
    for p_opt in opts:
        ...
        if product:
            ...
            <td>%s</td>
            <td/>
            <td><a href="%s" class="add-another" id="add_productvariation"> <img src="{%% static 'admin/img/icon_addlink.gif' %%}" width="10" height="10" alt="Add ProductVariation"/> Add Variation</a></td>
            </tr>
            """ % (opt_str, add_url)
    output += "</table>"
    t = Template(output)
