...
from livesettings.functions import config_value, config_choice_values, SettingNotSet
...
class CreditCardDetail(models.Model):
    ...
    displayable number.
    """
    orderpayment = models.OneToOneField('shop.OrderPayment', related_name="creditcards")
